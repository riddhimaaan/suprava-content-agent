...
Claude Code plugin for Suprava's content pipeline — research, platform writing, and humanization in one skill.
...
```
claude plugin marketplace add riddhimaaan/suprava-content-agent-claudeplugin
claude plugin install suprava-content-agent@suprava-content-agent-claudeplugin
```
